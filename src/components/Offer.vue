    ...
    <div class="site-main">
        <div class="site-main-inner">
            <div class="main-section offer-section">
                <h1 class="main-title">Offer</h1>

                <p>
                    <strong>A <span class="red">full-stack software engineer</span> with over
                        <span class="red">14 years of experience</span>.</strong>
                </p>

                <p>
                    <strong>I have maintained, developed and launched
                        <a href="../portfolio/index.html" class="nocolor">multiple projects</a>
                        from scratch</strong>, carrying the development of its' back-end and front-end
                    codebases.
                </p>

                <p>
                    My current toolset includes
                    <strong>Elixir Language & Phoenix Framework, JavaScript & TypeScript
                        (Node.js as well)</strong>, Ruby & Ruby on Rails, <strong>React</strong>, Redux, Angular,
                    Kubernetes, Docker and all the other various frameworks, libraries
                    and technologies related to them.
                </p>

                <p>
                    <strong>I can help you with all the sides of your project:</strong>
                </p>
                <ul>
                ...
                <p>
                    <strong>I specialize in applications written in both React and
                        Angular.</strong>
                ...
                <ul>
                    ...
                    <li>
                        ...
                        <a href="https://webpack.js.org/" rel="nofollow">Webpack</a> with
                        features like automatic code reload, code minifications, multiple
                        environments support, CI/CD, Storybook components library,
                        automated testing of accessibility, server-side render and visual
                        snapshots,
                    </li>
       ...
       <strong>You can already find some of my mobile applications in <a href="/portfolio/">my portfolio</a>.</strong>
                ...
                <div class="row features">
                    <div class="col col-4 feature">
                        <div class="feature-icon feature-number">14</div>
                    ...
                    <div class="col col-4 feature">
                        <div class="feature-icon feature-number">9</div>
                        <div class="feature-description">
                ...
                <p>
                    <strong>In back-end development, my current stack involves
                        <a href="http://elixir-lang.org/" rel="nofollow">Elixir</a> &
                        <a href="http://phoenixframework.org/" rel="nofollow">Phoenix</a>,
                        <a href="https://nodejs.org/" rel="nofollow">NodeJS</a> and
                        <a href="https://nestjs.com/" rel="nofollow">nest.js</a></strong>, and
                    <a href="http://rubyonrails.org/" rel="nofollow">Ruby on Rails</a>.
                </p>
                <p>
                    ...
                    servers using just the shell, then Chef/Ansible, and now Docker and
                    Kubernetes.
                </p>
                <p>
                    The lessons I learned while doing all these apps will be useful for
                    me forever, no matter what framework I will use in the next project.
                </p>
                ...
                <ul>
                    ...
                    <li>
                        ...
                        <a href="https://www.postgresql.org/" rel="nofollow">PostgreSQL</a>, <a href="https://www.mysql.com/" rel="nofollow">MySQL</a>,
                        <a href="http://www.elasticsearch.org/" rel="nofollow">Elasticsearch</a>, <a href="http://redis.io/" rel="nofollow">Redis</a>)
                    </li>
                    <li>
                    ...
                    <li>
                        ...
                        into separate modules (<a href="https://en.wikipedia.org/wiki/Domain-driven_design" rel="nofollow">DDD</a>), and moving the app architecture into an event-based one
                    </li>
                ...
                <p>
                    <strong>During my time I have created and released tens of
                        websites.</strong>
                </p>

                <p>
                    Thus, not only I have coded their back-end and front-end codebases,
                    but often I also had to care about other things needed in a
                    successful web application project:
                </p>
                ...
                <ul>
                    ...
                    <li>
                        in cases where a good Project Manager was missing, fullfilling his
                        role, in order to save the project from losing time on unneeded
                        things.
                    </li>
                </ul>
                ...
                <p>
                    ...
                    it's okay. Send the design job to someone else, and I will take care
                    of all the code development, or whatever other role you see me best
                    in.
                </p>

                <p>
                    In cases when you already have an existing team, but you would still
                    use some help, <a href="../contact/index.html">contact me</a> as
                    well. I’ll fit in very quickly, I promise.
                </p>
            </div>
        </div>
    </div>
